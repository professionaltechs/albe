import * as style from "../../../styles/services/projectManagement/projectProgramming.module.css";
import trophy from "../../../public/images/trophy.png";
import automation from '../../../public/images/Automation_Software.webp'
import Image from "next/image";

export default function ProjectManagementProgramming() {
  return (
    <div className={style.plcProgrammingMain}>
      <div className={style.plcProgramming}>
        <img
          src="/images/Project_Manager.webp"
          // src={automation}
