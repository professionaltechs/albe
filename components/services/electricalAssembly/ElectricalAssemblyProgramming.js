import * as style from "../../../styles/services/electricalAssembly/electricalProgramming.module.css";
import trophy from "../../../public/images/trophy.png";
import automation from '../../../public/images/Automation_Software.webp'
import Image from "next/image";

export default function ElectricalAssemblyProgramming() {
  return (
    <div className={style.plcProgrammingMain}>
      <div className={style.plcProgramming}>
        <img
          src="/images/Electrical_Assembly.webp"
          // src={automation}
