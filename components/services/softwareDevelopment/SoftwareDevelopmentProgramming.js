import * as style from "../../../styles/services/softwareDevelopment/softwareProgramming.module.css";
import trophy from "../../../public/images/trophy.png";
import automation from '../../../public/images/Automation_Software.webp'
import Image from "next/image";

export default function SoftwareDevelopmentProgramming() {
  return (
    <div className={style.plcProgrammingMain}>
      <div className={style.plcProgramming}>
        <img
          src="/images/Software_Engineer.webp"
          // src={automation}
