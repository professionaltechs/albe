...
import * as style from "/styles/electricalassembly.module.css";
...
export default function electricalassembly() {
  ...
  return (
    <>
      <Head>
        <title>
          Electrical Assembly | Electrical Engineering| Albe engineering
        </title>
        <meta
          name="description"
          content="Leaders in electrical assembly and electrical engineering. Our team of electrical engineers and electrical assemblers excel in production line automation. Whether you need an electrical fitter mechanic or electrical fitter, we ensure maximum efficiency in manufacturing. Experience the best in assembly line solutions with our top-notch electrical services."
        />
                <script
        ...
        />
        <link rel="alternate" hreflang="en-au" href="https://www.albeengineering.com/services/electrical-assembly" />
      </Head>
      <Layout>
        <div className={style.service}>
          {/* <!-- service  -->   */}
          <ServiceBanner title="Electrical Assembly" />

          <ServicesCardsSection
            cardTitle="Eletrical Assembly"
            cardPara="Specialized in the assembly of electrical control panels,
            home automation and plant engineering of complete lines.
            the experience we have gained in the field of electrical
            assemblies allows us to give our customers high quality
            technical improvements."
            imgSrc="/images/Electrical_Assembly.webp"
            imgAlt="Electrical_Assembly"
            iconSrc="/icons/Eletrical-Assembly-White.png"
            iconAlt="Eletrical-Assembly-White"
            iconTitle="Eletrical-Assembly-White"
          />
