...
import * as style from "/styles/projectmanagement.module.css";
...
const projectManagement = () => {
  ...
  return (
    <>
      <Head>
        <title>project management - Automation Engineers</title>
        <meta
          name="description"
        ...
        />
          <link rel="alternate" hreflang="en-au" href="https://www.albeengineering.com/services/project-management" />
      </Head>
      <Layout>
        <div className={style.service}>
          {/* <!-- service  -->   */}
          <ServiceBanner title="Project Management" />

          <ServicesCardsSection
            cardTitle="Project Management"
            cardPara="Our project manager is responsible for the day-to-day
              management of the project and we are competent in managing
              the six aspects of a project, namely scope, planning,
              finance, risk, quality, and resources. our project
              managers have numerous years of experience and are
              competent at managing projects in complex environments."
            imgSrc="/images/Project_Manager.webp"
            imgAlt="Project_Manager"
            iconSrc="/icons/Project-Manager-White.png"
            iconAlt="Project Manager White"
            iconTitle="Project Manager White"
          />
